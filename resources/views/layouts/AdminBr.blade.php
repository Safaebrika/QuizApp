    ...
    <div id="app">
                    ...
                    <ul class="navbar-nav  ms-auto ">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('logoutt') }}"> déconnecter</a></li>
                            </ul>
                        </li>
            ...
            <aside>
                ...
                <a href="{{ route('Createquestion') }}">
                    <span class="d-none d-sm-inline">
                        ...
                        Ajouter des questions </span>
                </a>
                <a href="{{ route('Createoption') }}">
        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                <div class=" sidebr col-auto col-md-3 col-xl-2  side">
                    <div
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                            ...
                            <li>
                                <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                    ...
                                    <li class="w-100">
                                        <a href="{{ route('CreateCategory') }}" class="a   px-0">
                                            <div class="d-none d-sm-inline">
                                                <svg xmlns="http://www.w3.org/2000/svg" width=" 35 " height=""
                                                    fill="currentColor" class="bi bi-grid-fill" viewBox="0 0 16 16">
                                                    <path
                                                        d="M1 2.5A1.5 1.5 0 0 1 2.5 1h3A1.5 1.5 0 0 1 7 2.5v3A1.5 1.5 0 0 1 5.5 7h-3A1.5 1.5 0 0 1 1 5.5v-3zm8 0A1.5 1.5 0 0 1 10.5 1h3A1.5 1.5 0 0 1 15 2.5v3A1.5 1.5 0 0 1 13.5 7h-3A1.5 1.5 0 0 1 9 5.5v-3zm-8 8A1.5 1.5 0 0 1 2.5 9h3A1.5 1.5 0 0 1 7 10.5v3A1.5 1.5 0 0 1 5.5 15h-3A1.5 1.5 0 0 1 1 13.5v-3zm8 0A1.5 1.5 0 0 1 10.5 9h3a1.5 1.5 0 0 1 1.5 1.5v3a1.5 1.5 0 0 1-1.5 1.5h-3A1.5 1.5 0 0 1 9 13.5v-3z" />
                                                </svg>
                                                Ajouter des catégories</span> </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('Createquestion') }}" class="a   px-0"> <span
                                                class="d-none d-sm-inline">
                                                <svg xmlns="http://www.w3.org/2000/svg" width=" 35 " height=""
                                                ...
                                                Ajouter des questions </span> </a>
                                    </li>

                            </li>
                            <li>
                                <a href="{{ route('Createoption') }}" class=" a  px-0   align-middle">
                            ...
                            <li>
                                <a href="#submenu2" data-bs-toggle="collapse"
                                    ...
                                    <i class="fs-4 bi-bootstrap"></i> <span class="ms-1 d-none d-sm-inline">
                                        ...
                                        Voir statiques</span></a>

                            </li>
                            <li>
                                <a class=" a  px-0  align-middle" href="{{ route('logoutt') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width=" 35 " height=""
